...
Canonical overlay: capabilities/overlays/lra-governance.md
...
Repository: `lra-governance`
Canonical repo overlay: `capabilities/overlays/lra-governance.md`
Canonical route resolver:
`python <governance-root>/scripts/govpy.py capabilities/resolve.py --repo lra-governance --task "<user task>" --root <repo-root>`
