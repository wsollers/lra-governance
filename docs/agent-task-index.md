...
| Create stub chapter | `docs/governance/stub-chapter-standards.md`, `docs/governance/volume-structure.md` | `constitution/schema/file-schema.yaml` | `tools/governance/audit_volume_layout.py` | `docs/workflows/volume-cleanup.md` | chapter skeleton, chapter metadata, notes/proofs routers | volume layout audit, build or documented no-build reason |
| Create stub section | `docs/governance/stub-section-standards.md`, `docs/governance/volume-structure.md` | `constitution/schema/file-schema.yaml` | `tools/governance/audit_volume_layout.py` | `docs/governance/stub-chapter-standards.md` | paired `notes/{topic}/` and `proofs/{topic}/` folders and routers | volume layout audit, build |
