...
| Add theorem with proof stub | `docs/workflows/add-theorem-with-proof-stub.md`, `docs/governance/proof-standards.md`, `docs/governance/dependency-standards.md`, `docs/architecture/local-semantic-logic-verifier.md` | `constitution/schema/file-schema.yaml`, `constitution/schema/artifact-matrix.yaml`, semantic artifact package | `tools/governance/validate_volume.py`, `tools/governance/audit_proof_layout.py`, `tools/governance/validate_semantic_artifact.py`, `tools/governance/validate_semantic_logic.py`, `tools/governance/compare_semantic_ast_extractors.py` | `docs/governance/atomic-artifact-standards.md`, `docs/governance/volume-structure.md` | theorem/proposition/lemma/corollary source, canonical proof stub, semantic artifact evidence | semantic artifact validation, local semantic logic validation, independent AST extractor comparison, integrated volume validation, proof layout audit, volume build |
| Add definition | `docs/governance/authoring-standards.md`, `docs/governance/atomic-artifact-standards.md`, `docs/governance/notation-standards.md`, `docs/governance/latex-math-style.md`, `docs/governance/dependency-standards.md`, `docs/architecture/local-semantic-logic-verifier.md` | `constitution/schema/artifact-matrix.yaml`, `constitution/schema/block-registry.yaml`, semantic artifact package | `tools/governance/validate_volume.py`, `tools/governance/validate_latex_math_style.py`, `tools/governance/validate_semantic_artifact.py`, `tools/governance/validate_semantic_logic.py`, `tools/governance/compare_semantic_ast_extractors.py`, volume build | `docs/governance/model-standards.md` | definition source, semantic artifact evidence, and any notation/predicate updates | semantic artifact validation, notation/style validation for changed TeX, local semantic logic validation, independent AST extractor comparison, integrated volume validation, YAML parse when data changes, volume build |
