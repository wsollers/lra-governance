...
| Add definition | `docs/governance/authoring-standards.md`, `docs/governance/atomic-artifact-standards.md`, `docs/governance/notation-standards.md`, `docs/governance/dependency-standards.md`, `docs/architecture/local-semantic-logic-verifier.md` | `constitution/schema/artifact-matrix.yaml`, `constitution/schema/block-registry.yaml`, semantic artifact package | `tools/governance/validate_volume.py`, `tools/governance/validate_semantic_artifact.py`, `tools/governance/validate_semantic_logic.py`, `tools/governance/compare_semantic_ast_extractors.py`, volume build | `docs/governance/model-standards.md` | definition source, semantic artifact evidence, and any notation/predicate updates | semantic artifact validation, local semantic logic validation, independent AST extractor comparison, integrated volume validation, YAML parse when data changes, volume build |
...
| Update predicates, structures, relations, or notation | `docs/governance/notation-standards.md`, `docs/governance/predicate-standards.md`, `docs/architecture/canonical-yaml.md` | canonical YAML files in `lra-governance` root | YAML parser, symbol audit when available | `docs/governance/dependency-standards.md`, `constitution/prompts/audit-chapter-symbols.md` | canonical YAML changes or audit report | YAML parse, extractor/build if affected |
