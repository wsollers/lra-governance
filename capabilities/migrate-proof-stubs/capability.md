...
should be migrated with the leaf-local migration tool rather than hand-edited.
...
should not be treated as ready or merged until migrated. Do not add a
non-blocking migration-mode flag unless explicitly approved for a specific
repository and removed after the migration window.
