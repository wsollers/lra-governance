...
`capabilities/add-tikz-figure/style-guide.md`. Shared implementations belong in `lra-common`, not in
...
- generated TikZ shall use the shared house style from `capabilities/add-tikz-figure/style-guide.md`
