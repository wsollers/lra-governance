...
not this file. -->
# Repo Overlay -- lra-volume-i

Repo identity: Logic, Sets, and Proof.

Scope:
- Volume content only. Edit only this volume's `volume-i/` content unless the
...
- Chapters route through `volume-i/index.tex` and the owning book root. Chapter
